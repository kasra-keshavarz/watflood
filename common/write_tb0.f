...
!     fixed format for the date      
     ...
     *     year_NOW,mo_start,day_start,hour_start
3027  format(a20,i4.4,'/',i2.2,'/',i2.2,'  ',i2.2,':00:00')      
...
c      if(wrtstrflg)then
c        write(un,3022)'   :Coeff1         ',(Coeff1(l),l=1,ng)
c        write(un,3022)'   :Coeff2         ',(Coeff2(l),l=1,ng)
c        write(un,3022)'   :Coeff3         ',(Coeff3(l),l=1,ng)
c        write(un,3022)'   :Coeff4         ',(Coeff4(l),l=1,ng)
c        write(un,3022)'   :Value1         ',(Value1(l),l=1,ng)
        write(un,3022)'   :Coeff1         ',(0.0,l=1,ng)
        write(un,3022)'   :Coeff2         ',(0.0,l=1,ng)
        write(un,3022)'   :Coeff3         ',(0.0,l=1,ng)
        write(un,3022)'   :Coeff4         ',(0.0,l=1,ng)
        write(un,3024)'   :Value1         ',(1,l=1,ng)   !format fixed Apr. 10/22 NK
c      endif
...
! FORMATS
 ...
 3012 format(a9)
 3020 format(a20,a40)
 3021 format(a23,<ng>(a9,3x))
 3022 format(a20,<ng>f12.2)
 3023 format(a20,<ng>f12.4)
 3024 format(a20,<ng>i12)    
 3029 format(a20,<ng>f10.0)
