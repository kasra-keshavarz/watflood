...
!         ADD UPSTREAM INFLOWS FOR ALL CONTRIBUTING LAKE GRIDS AND LAND STORAGE COMPARTMENTS:
     ...
     *             +iso2HSTRin2(n)+iso2Hin2str(n)*t/3600.
	    qLKin2H(rbin)=qLKin2H(rbin)+qinn(n,classcount-1)+minflwSTR(n)/3600.
