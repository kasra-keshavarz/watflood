...
!     For 2H 
	...
	REAL*4  :: nexp,density,phi
      REAL*8  :: rvsmow,glconc,snwconc,snwmconc,snwrfconc !,rvalue,dvalue


      REAL*8, DIMENSION(:,:), ALLOCATABLE :: 
     *                       isodef,isowater,isowcl
      REAL*8, DIMENSION(:), ALLOCATABLE   :: STRconc2,
     *                                       dSTRconc2,dLKconc2
...
!     rev. 9.5.03  Dec.  09/07  - NK: added reads for precip isotopes
     ...
     *    snwmconc/0.002181175/snwrfconc/0.002131175/  ! Ft. Simpson
