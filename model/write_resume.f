...
!     rev. 10.3.03 Jan.  21/20  = NK added dd_ice & dd_thaw to the resume.txt file      
        ...
        block=11      ! dd_thaw
        write(99,*)block,' block    ice_fctr'   
        write(99,*)(ice_fctr(n),n=1,na)

c        block=12      ! dd_ice_min
c        write(99,*)block,' block    dd_ice_min'   
c        write(99,*)(dd_ice_min(n),n=1,na)

c        block=13      ! dd_ice_sum
c        write(99,*)block,' block    dd_ice_sum'   
c        write(99,*)(dd_ice_sum(n),n=1,na)
