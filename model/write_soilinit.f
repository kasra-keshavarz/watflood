...
!     Initial upper zone storage mm snow
      do ii=1,classcount
        ...
        write(99,4012)k,'uzsfs  class',ii
        do i=1,ycount
          write(99,4009)(p(i,j),j=1,xcount)
        end do
	end do
...
!     Initial snow water equivalent in mm swe 
      do ii=1,classcount
        ...
        write(99,4012)k,'snowc  class',ii
        do i=1,ycount
          write(99,4009)(p(i,j),j=1,xcount)
        end do
	end do
...
!     Initial ttomin  
      ...
      do n=1,naa
        ...
        write(99,4012)k,'ttomin  class',ii
	do i=1,ycount
        write(99,4009)(p(i,j),j=1,xcount)
      end do
...
!     Initial ttomax 
      ...
      do n=1,naa
        ...
        write(99,4012)k,'ttomax  class',ii
	do i=1,ycount
        write(99,4009)(p(i,j),j=1,xcount)
      end do
